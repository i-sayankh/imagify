                    ...
                    user ? (
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <button onClick={() => navigate('/buy-credit')} className="flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700">
                                ...
                                <p className="text-xs sm:text-sm font-medium text-gray-600">Credits Left: 69</p> {/* Displaying Remaining Credits */}
                            </button>

                            {/* Greeting for Logged-in User */}
                            <p className="text-gray-600 max-sm:hidden pl-4">Hi! Sayan</p>
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12">
                                    <ul className="list-none m-0 p-2 bg-white rounded-md border text-sm">
                                        <li className="py-1 px-2 cursor-pointer pr-10">Logout</li> {/* Logout Option */}
                                    </ul>
                                </div>
                            </div>
                        </div>
